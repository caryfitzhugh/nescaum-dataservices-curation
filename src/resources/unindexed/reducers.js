...
function unindexedReducer(state = INITIAL_UNINDEXED_STATE, action) {
  switch (action.type) {
    case START_UNINDEXED_RESOURCES_REQUEST:
      return {page: action.page, is_searching: true, response: {}, error: null};

    case FINISH_UNINDEXED_RESOURCES_REQUEST:
      return {page: action.page, is_searching: false, response: action.response, error: null};

    case ERROR_UNINDEXED_RESOURCES_REQUEST:
      return {page: action.page, is_searching: false, response: {}, error: action.error};
